...
$(document).ready(function () {
    ...
    $("#tablaReservaciones").on("click", ".btn-danger", function () {
        ...
        var texto = datos.idSmartphone.marca + " " + datos.idSmartphone.modelo + " $" + datos.idSmartphone.precio +
            "\nUsuario: " + datos.idUsuario.correo;
        swal({
        ...
        swal({
            ...
            , function () {
                $.post("/venta/registrar",
                        {idSmartphone: datos.idSmartphone.idSmartphone,
                        usuario: datos.idUsuario.idUsuario},
                    function () {
                        $.post("/reservacion/eliminar",
